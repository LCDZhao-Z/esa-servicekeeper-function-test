...
import io.esastack.servicekeeper.adapter.spring.ServiceKeeperConfigurator;
...
public class Application {
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        System.setProperty("servicekeeper.config.dir", "./cabin-test/spring-file-source/conf");
